...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "malvin~97cUWSCA#1aDbH-ZLWglxrVZxQc5Bw7lkhRrn9i3uXdbWqSn-olw",
// add your Session Id make sure it starts with malvin~
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "ᴍELO-xᴅ",
...
// automatic delete links witho remove member 
          ...
          OWNER_NUMBER: process.env.OWNER_NUMBER || "23290729208",
// add your bot owner number

OWNER_NAME: process.env.OWNER_NAME || "ᴍELOS-ᴋɪɴɢ",
// add bot owner name
...
// true if want mark commands as read 
     ...
     DEV: process.env.DEV || "23290729208",
